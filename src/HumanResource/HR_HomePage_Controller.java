...
public class HR_HomePage_Controller {

    @FXML
    private Button AddEmployee_Button;

    @FXML
    private Button ApproveApplications_Button;

    @FXML
    private Button ManageSalary_Button;

    @FXML
    private Button UpdatePerformance_Button;

    @FXML
    private Button NewButton;

    @FXML
    private Button Grievanes_Button;
    ...
    @FXML
    void onClick_ApproveApplications_Button(ActionEvent event) throws IOException {
    	AnchorPane HR_Add_Employee = (AnchorPane) FXMLLoader.load(getClass().getResource("HR_Approve_Applications.fxml"));
        Stage window1 = (Stage) ((Node)event.getSource()).getScene().getWindow();
    ...
    @FXML
    void onClick_Grievanes_Button(ActionEvent event) throws IOException {
    ...
    @FXML
    void onClick_ManageSalary_Button(ActionEvent event) throws IOException {
    ...
    @FXML
    void onClick_NewButton(ActionEvent event) throws IOException {
    ...
    @FXML
    void onClick_UpdatePerformance_Button(ActionEvent event) throws IOException {
